...
export const COMMAND_EXCHANGE_PRESENTATION = 'remoteNotifier.exchangeAttentionPresentation';
...
export const ENV_CODEX_HOOK_AVAILABLE = 'REMOTE_NOTIFIER_CODEX_HOOK_AVAILABLE';
export const ENV_CODEX_INVOCATION_ID = 'REMOTE_NOTIFIER_CODEX_INVOCATION_ID';
export const ENV_CODEX_PROTOCOL_SESSION = 'REMOTE_NOTIFIER_CODEX_PROTOCOL_SESSION';
